            ...
            <div className="main-product-image">
              <img
                src={
                  ...
                  "https://via.placeholder.com/594x600"
                }
            ...
            <div className="main-product-details">
              ...
              <div className="d-flex align-items-center gap-10">
                <ReactStars
                  count={5}
                  size={24}
                  value={productState?.averageRating || 0}
                  edit={false}
                  activeColor="#ffd700"
                />
                <p className="mb-0 t-review">
                  ({productState?.reviews?.length || 0} Reviews)
                </p>
              </div>
              ...
              <div className="d-flex gap-10 align-items-center my-2">
                ...
                <p className="product-data">{productState?.weight || "N/A"}</p>
              </div>
              <div className="d-flex gap-10 align-items-center my-2">
